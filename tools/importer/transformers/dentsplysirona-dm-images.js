...
/**
 * Transformer: dentsplysirona Dynamic Media / Scene7 images.
 * Source (dentsplysirona.com/de-ch) serves images from s7d1.scene7.com/is/image/...
 * Rewrites DM/Scene7 <img> tags into anchors so the URL round-trips through
 * markdown; a companion auto-block in scripts/scripts.js rebuilds responsive
 * <picture> elements at load time.
 *
 * Runs in afterTransform ONLY: block parsers run between the hooks and extract
 * <img> references into block cells (cards/carousel), so rewriting imgs to
 * anchors earlier would leave parsers with empty image cells.
 */

// ---- Begin canonical helpers (byte-identical with dm-scene7-helpers.js) ----
